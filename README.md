...
> Version `0.16.1` · Production · Docker: `vladimirovrosen/odoo-erpnet-fp:0.16.1` (also `:latest`)
> Access-control image (offline ZEN): build with `--build-arg EXTRAS=zen`, tag `:0.16.1-zen`.
